...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '323604fdf2f7b65baf4-02341496',
  'function' => 
  array (
  ),
...
<tr>
<td><a href="datos.php?accion=obra_lista&letra=todas">*</a></td>
<td><a href="datos.php?accion=obra_lista&letra=A">A</a></td>
<td><a href="datos.php?accion=obra_lista&letra=B">B</a></td>
<td><a href="datos.php?accion=obra_lista&letra=C">C</a></td>
<td><a href="datos.php?accion=obra_lista&letra=D">D</a></td>
<td><a href="datos.php?accion=obra_lista&letra=E">E</a></td>
<td><a href="datos.php?accion=obra_lista&letra=F">F</a></td>
<td><a href="datos.php?accion=obra_lista&letra=G">G</a></td>
<td><a href="datos.php?accion=obra_lista&letra=H">H</a></td>
<td><a href="datos.php?accion=obra_lista&letra=I">I</a></td>
<td><a href="datos.php?accion=obra_lista&letra=J">J</a></td>
<td><a href="datos.php?accion=obra_lista&letra=K">K</a></td>
<td><a href="datos.php?accion=obra_lista&letra=L">L</a></td>
<td><a href="datos.php?accion=obra_lista&letra=M">M</a></td>
<td><a href="datos.php?accion=obra_lista&letra=N">N</a></td>
<td><a href="datos.php?accion=obra_lista&letra=Ñ">Ñ</a></td>
<td><a href="datos.php?accion=obra_lista&letra=O">O</a></td>
<td><a href="datos.php?accion=obra_lista&letra=P">P</a></td>
<td><a href="datos.php?accion=obra_lista&letra=Q">Q</a></td>
<td><a href="datos.php?accion=obra_lista&letra=R">R</a></td>
<td><a href="datos.php?accion=obra_lista&letra=S">S</a></td>
<td><a href="datos.php?accion=obra_lista&letra=T">T</a></td>
<td><a href="datos.php?accion=obra_lista&letra=U">U</a></td>
<td><a href="datos.php?accion=obra_lista&letra=V">V</a></td>
<td><a href="datos.php?accion=obra_lista&letra=W">W</a></td>
<td><a href="datos.php?accion=obra_lista&letra=X">X</a></td>
<td><a href="datos.php?accion=obra_lista&letra=Y">Y</a></td>
<td><a href="datos.php?accion=obra_lista&letra=Z">Z</a></td>
</tr>
</table>



<?php if (!empty($_smarty_tpl->tpl_vars['obras']->value)){?>
<!--Numero de columnas que queremos mostrar-->
<?php $_smarty_tpl->tpl_vars["columnas"] = new Smarty_variable("4", null, 0);?> 

<?php echo smarty_function_math(array('equation'=>"ceil(count / columnas)",'count'=>count($_smarty_tpl->tpl_vars['obras']->value),'columnas'=>$_smarty_tpl->tpl_vars['columnas']->value,'assign'=>"columnHeight"),$_smarty_tpl);?>
...
?> 
		<td> 
		<?php if (isset($_smarty_tpl->tpl_vars['obras']->value[$_smarty_tpl->getVariable('smarty',null,true,false)->value['section']['td']['index']])){?> 
			<a href="datos.php?accion=obra&id=<?php echo $_smarty_tpl->tpl_vars['obras']->value[$_smarty_tpl->getVariable('smarty')->value['section']['td']['index']]['obra_id'];?>
">
				<?php echo $_smarty_tpl->tpl_vars['obras']->value[$_smarty_tpl->getVariable('smarty')->value['section']['td']['index']]['obra_nombre'];?>
 (<?php echo $_smarty_tpl->tpl_vars['obras']->value[$_smarty_tpl->getVariable('smarty')->value['section']['td']['index']]['profesional_nombre'];?>
 <?php echo $_smarty_tpl->tpl_vars['obras']->value[$_smarty_tpl->getVariable('smarty')->value['section']['td']['index']]['profesional_apellido1'];?>
 <?php echo $_smarty_tpl->tpl_vars['obras']->value[$_smarty_tpl->getVariable('smarty')->value['section']['td']['index']]['profesional_apellido2'];?>
)
			</a> 
		<?php }?> 
		</td> 
