...
$maxSize           = TAM_MAX; 											
$imagesPath        = RUTA_ARCHIVOS.DIRECTORY_SEPARATOR."imagen".DIRECTORY_SEPARATOR."noticias".DIRECTORY_SEPARATOR; 											
$imagesThumbsPath  = $imagesPath."miniaturas".DIRECTORY_SEPARATOR;
$imagesUrl         = DOMINIO.'/'.URL_ARCHIVOS."/imagen/noticias/"; 													
$imagesTumbsUrl    = $imagesUrl."miniaturas/";
