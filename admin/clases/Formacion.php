	...
	{			
		...
		{				
			...
			$this->campos = array(
				...
				'formacion_actualmente'    => array('tipo'=>'checkbox','nulo'=>true,'msg'=>t('Invalid actualmente'),'valor'=>'','lectura'=>false),
		...
		{		
			...
			if ( !is_numeric($this->campos['formacion_fechafin']['valor'])  && $this->campos['formacion_fechafin']['valor']!= "" )
			{
				$this->campos['formacion_actualmente']['valor'] = 1;
				$this->campos['formacion_fechafin']['valor'] = null;
			}
			else
			{
				$this->campos['formacion_actualmente']['valor'] = 0;
			}
		...
		{
			$bd                = BD::Instancia();			
			$consulta          = "SELECT formacion_id, formacion_titulo, DATE_FORMAT(formacion_fechainicio, '".FORMATO_FECHA_MYSQL_ANYO."') AS formacion_fechainicio, DATE_FORMAT(formacion_fechafin, '".FORMATO_FECHA_MYSQL_ANYO."') AS formacion_fechafin, formacion_detalles,formacion_actualmente, centro_nombre, centro_codigo, centro_tipo 
